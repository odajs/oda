...
export default {
    api: 'oda-color-cpicker',
    source: [
        { label: 'cpicker.js', src: './cpicker.js', title: 'source code oda-color-cpicker' },
        { label: 'picker-cse.js', src: './modules/picker-cse.js', title: 'source code picker-cse' },
        { label: 'picker.js', src: './modules/picker.js', title: 'source code picker' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component color-cpicker</span></b><span> - is ODA component.</span></div>
