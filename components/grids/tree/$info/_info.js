...
export const info = {
    api: 'oda-tree',
    source: [
        { label: 'tree.js', src: './tree.js', title: 'source code oda-tree' },
        { label: 'table.js', src: '../table/table.js', title: 'source code oda-table' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component tree inherited from table</span></b><span> - is ODA component.</span></div>
