...
export const info = {
    api: 'oda-app-layout',
    source: [
        { label: 'app-layout.js', src: './app-layout.js', title: 'source code oda-app-layout' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component app-layout inherited from form-layout and splitter</span></b><span> - is ODA component.</span></div>
