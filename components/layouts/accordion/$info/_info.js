...
export const info = {
    api: 'oda-accordion',
    source: [
        { label: 'accordion.js', src: './accordion.js', title: 'source code oda-accordion' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow;margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component accordion inherited from button</span></b><span> - is ODA component.</span></div>
