...
export const info = {
    api: 'oda-splitter',
    source: [
        { label: 'splitter.js', src: './splitter.js', title: 'source code oda-splitter' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component splitter inherited from icon</span></b><span> - is ODA component.</span></div>
