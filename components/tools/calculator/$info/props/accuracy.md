Свойство **accuracy** определяет точность выводимого результата.
...
ODA({
    is: 'my-component',
    template: `
        <label>Точность вычислений<input type="number" ::value="accuracy"><label>
        <oda-calculator :accuracy :data></oda-calculator>
    `,
    props: {
        accuracy: 2,
        data: {
