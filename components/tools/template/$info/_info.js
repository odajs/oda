...
export default {
    api: 'oda-palette',
    source: [
        { label: 'palette.js', src: './palette.js', title: 'source code oda-palette' }
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component oda-palette includes oda-color-line and oda-gradient-preview</span></b><span> It is ODA component.</span></div>
