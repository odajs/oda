...
export default {
    api: 'oda-checkbox',
    source: [
        { label: 'checkbox.js', src: './checkbox.js', title: 'source code oda-checkbox' },
    ],
    ...
    about:`
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow;margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component checkbox inherited from icon</span></b><span> - is ODA component.</span></div>
