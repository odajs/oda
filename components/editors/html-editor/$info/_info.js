...
export default {
    api: 'oda-html-editor',
    source: [
        { label: 'html-editor.js', src: './html-editor.js', title: 'source code oda-html-editor' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component html-editor inherited from ace-editor</span></b><span> - is ODA component.</span></div>
