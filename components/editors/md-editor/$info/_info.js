...
export default {
    api: 'oda-md-editor',
    source: [
        { label: 'md-editor.js', src: './md-editor.js', title: 'source code oda-md-editor' },
    ],
    ...
    about: `
        <div style="border: 1px solid ; color: #6699cc; background-color: lightyellow; margin: 10px;padding: 10px;border-radius: 2px;">
            <div horizontal=""><b><span>Component md-editor inherited from ace-editor</span></b><span> - is ODA component.</span></div>
