...
import {bestDinoBrain} from './dino-brain.js'
...
function DinoFactory() {
    ...
    class NeuroDino extends HTMLElement {
        ...
        connectedCallback() {
            ...
            //     }
            // });
            // this.style.transform = `translateX(${Math.random()*100}px)`;
            //this.style.transform = `translate(${Math.random()*100}px, ${Math.random()*200}px)`;
