    ...
    template: `
        ...
        <oda-app-layout>
            <div slot="title" class="horizontal header border">
                <div class="flex"></div>
                <div>
                    <a target="_blank" style="margin: 4px; font-size: 40px; font-weight: 600; font-family: 'Comfortaa', cursive; ">Bugs Intersection Test</a>
                </div>
            ...
            <oda-property-grid2 slot="right-panel" class="vertical flex border" label="Intersection ellipse" :io="this" style="padding:0" show-buttons="false"></oda-property-grid2>
            <div slot="bottom">
