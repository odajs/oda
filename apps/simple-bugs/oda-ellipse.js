...
ODA({
        ...
        <oda-app-layout>
            ...
            <div slot="main" id="render-box">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" @tap="setCurrentPoint" ~ref="'svg'" @pointerdown="_down" @pointerup="_stopMove">
                    ...
                    <line id="line1" :x1="line1.coords.x1" :y1="line1.coords.y1" :x2="line1.coords.x2" :y2="line1.coords.y2" :stroke="line1.color" ~show="line1.isShow" :stroke-width="line1.borderWidth"/>
                    <line id="line2" :x1="line2.coords.x1" :y1="line2.coords.y1" :x2="line2.coords.x2" :y2="line2.coords.y2" :stroke="line2.color" ~show="line2.isShow" :stroke-width="line2.borderWidth"/>
                    <line id="line3" :x1="line3.coords.x1" :y1="line3.coords.y1" :x2="line3.coords.x2" :y2="line3.coords.y2" :stroke="line3.color" ~show="line3.isShow" :stroke-width="line3.borderWidth"/>
    ...
    props: {
        ...
        ellipse2: {
            ...
            radiuses: { x: 200, y: 100 }, // { x: 100, y: 50 },
            angle: 45,
            isShow: true,
            color: 'blue',
            borderWidth: 2,
        ...
        line2: {
            default: {
                coords: { x1: 0, y1: 1000, x2: 1000, y2: 1000 },
                angle: 0,
                length: 150,
                isShow: true,
                color: 'green',
        ...
        line4: {
            ...
            default: {
                coords: { x1: 1000, y1: 0, x2: 1000, y2: 1000 },
                angle: 0,
                length: 150,
                isShow: true,
                color: 'red',
    ...
    ready() {
        setTimeout(() => {
            requestAnimationFrame(this.moveEllipse.bind(this));
        }, 100);
    },
    moveEllipse() {
        this.ellipse2.coords.x += this.ellipse2.v * Math.cos(this.ToRad(this.ellipse2.angle));
        this.ellipse2.coords.y += this.ellipse2.v * Math.sin(this.ToRad(this.ellipse2.angle));
        if (this.IsIntersectionLineToEllipse(this.line1)) {
            this.ellipse2.v = -this.ellipse2.v;
        }
        if (this.IsIntersectionLineToEllipse(this.line2)) {
            this.ellipse2.v = -this.ellipse2.v;
        }
        if (this.IsIntersectionLineToEllipse(this.line3)) {
            this.ellipse2.v = -this.ellipse2.v;
        }
        if (this.IsIntersectionLineToEllipse(this.line4)) {
            this.ellipse2.v = -this.ellipse2.v;
        }
        this.render();
        requestAnimationFrame(this.moveEllipse.bind(this));
    ...
    IsIntersectionLineToEllipse(line) {

        // Сдвиг системы координат
        const coords1 = {
            x1: line.coords.x1 - this.ellipse2.coords.x,
            y1: line.coords.y1 - this.ellipse2.coords.y,
            x2: line.coords.x2 - this.ellipse2.coords.x,
            y2: line.coords.y2 - this.ellipse2.coords.y,
        };
    ...
    AsIntersectionLineToEllipse(line) {
    ...
    StepIntersectionLineToEllipse(line) {
