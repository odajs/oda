...
ODA({
    ...
    attached() {
        ...
        this.async(() => {
            this.canvas.width = Math.round(this.size);
            this.canvas.height = Math.round(this.height || this.size);
        }, 300)
    },
    $observers: {
        _toUpdate(toUpdate, today) {
