...
![Потеря соединения](learn/_help/ru/_images/my-first-component/my-first-component1.png "Потеря соединения")

Эту игру можно запустить и в online режиме, указав в адресной строке браузера служебную ссылку «**chrome://dino**».

![Онлайн запуск игры](learn/_help/ru/_images/my-first-component/my-first-component2.png "Запуск игры в режиме online")
...
![Солист группы T-Rex](learn/_help/ru/_images/my-first-component/MarkBolan.jpeg "Марк Болан")
...
![Геймплей игры](learn/_help/ru/_images/my-first-component/my-first-component3.png "Геймплей игры")
...
![Пустое окно игры](learn/_help/ru/_images/my-first-component/empty-window.png "Пустое окно игры")
...
![Начальное окно игры](learn/_help/ru/_images/my-first-component/no-score-window.png "Начальное окно игры")
...
![Окно игры с надписью и очками](learn/_help/ru/_images/my-first-component/score-window.png "Окно игры с надписью и очками")
...
![Расположение ног](learn/_help/ru/_images/my-first-component/dino1.png "Первое расположение ног динозавра")

В первом положении одна нога поднята вверх, а вторая опущена вниз.

![Расположение ног](learn/_help/ru/_images/my-first-component/dino2.png "Второе расположение ног динозавра")
...
![Динозавр с большим глазом и закрытым ртом](learn/_help/ru/_images/my-first-component/dino3.png "Динозавр с большим глазом и закрытым ртом")
...
![Окно с динозавром](learn/_help/ru/_images/my-first-component/dino-window.png "Окно с динозавром")
...
![Начало игры](learn/_help/ru/_images/my-first-component/start-game-window.png "Начало игры")

При следующих нажатиях клавиши пробела динозавр будет просто подпрыгивать вверх.

![Прыжок динозавра](learn/_help/ru/_images/my-first-component/jump-dino-window.png "Прыжок динозавра")
...
![Графический примитив кактуса](learn/_help/ru/_images/my-first-component/cactus.png "Кактус")
...
![Движущийся кактус](learn/_help/ru/_images/my-first-component/cactus-move-window.png "Движущийся кактус")

Однако после окончания анимации кактус снова появится рядом с ней.

![Повторное появления кактуса](learn/_help/ru/_images/my-first-component/cactus-stop-move-window.png "Повторное появления кактуса")
...
![Удаление кактуса](learn/_help/ru/_images/my-first-component/dino-window.png "Удаление кактуса")
...
![Графический примитив облака](learn/_help/ru/_images/my-first-component/cloud.png "Графический примитив облака")
...
![Движение облака](learn/_help/ru/_images/my-first-component/cloud-move-window2.png "Движение облака")

Кроме этого, при многократной загрузке игры облако будет появляться на разной высоте.

![Разная высота облака](learn/_help/ru/_images/my-first-component/cloud-move-window.png "Разная высота облака")
...
![Графический примитив птеродактиля](learn/_help/ru/_images/my-first-component/pterodactyl1.png "Птеродактиль")

а вторая позиция — опущено вниз.

![Графический примитив птеродактиля](learn/_help/ru/_images/my-first-component/pterodactyl2.png "Птеродактиль")
...
![Передвижение птеродактиля](learn/_help/ru/_images/my-first-component/pterodactyl-move-window.png "Передвижение птеродактиля")
...
![Автоматическое создание элементов игры](learn/_help/ru/_images/my-first-component/create-elements-window.png "Автоматическое создание элементов игры")
...
![Game over](learn/_help/ru/_images/my-first-component/game-over-window.png "Game over")
...
![![Продолжение игры](learn/_help/ru/_images/my-first-component/continue-game-window.png "Продолжение игры")
...
![Давай займемся любовью](learn/_help/ru/_images/my-first-component/get-it-on.jpg "Давай займемся любовью")
