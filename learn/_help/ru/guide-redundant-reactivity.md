...
Интересное замечание. Если директиву **~for** для создания точек заменить на добавление точек с помощью функции **appendChild** JavaScript, то время рендеринга уменьшится примерно  в 100 раз.
