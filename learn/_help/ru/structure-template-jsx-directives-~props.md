...
В данном примере директива **~props** пытается создать атрибут **inner-text** в элементе **div**, но поскольку DOM-объект элемента содержит свойство **innerText**, вместо создания атрибута меняется содержимое текстового узла элемента.
