...
1. Обработка отсутствующих элементов массивов.
    ...
    ```info_md
    Если последовательность элементов массива не является непрерывной, то директива **~for** автоматически пропустит отсутствующие индексы. Количество HTML-элементов, созданных директивой, будет соответствовать фактическому количеству элементов в массиве.
    ```
    ...
    В этом примере в хуке **ready** создается массива **array** из 4 элементов. Затем инициализируются элементы с индексами **0** и **3**, а элементы с индексами **1** и **2** пропущены. Директива **~for** создала HTML-элементы **div** только для существующих элементов с индексами **0** и **3**.
