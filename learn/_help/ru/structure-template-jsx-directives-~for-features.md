...
1. Обработка отсутствующих элементов массивов.
    ...
    В этом примере в хуке **ready** создается массива **array** из 4 элементов. Затем инициализируются элементы с индексами **0** и **3**, а элементы с индексами **1** и **2** пропущены. Директива **~for** создает HTML-элементы **div** только для существующих элементов с индексами **0** и **3**.
