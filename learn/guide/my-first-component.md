...
6. Стиль надписи с количеством набранных очков задает отличный от стандартного представления размер шрифта и верхнего отступа.
...
7. Стиль надписи начала или окончания игры **game-over** определяет позицию расположения надписи относительно основной области игры.
...
8. Стиль отображения тиранозавра **oda-dino** задает его начальное расположение.
...
Для начала игры зададим обработчик нажатия клавиш в основном файле **oda-dino-game** следующим образом:
