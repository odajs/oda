...
При подключении этого модуля и указании тэга «**oda-cactus**» в индексном файле игры кактус появится и начнет двигаться справа налево до полного выхода за левую границу игры.
...
Для создания эффекта взмахов крыльев к ним был добавлен тэг **animate**, который будет поочередно скрывать и отображать определенное крыло через заданный временной интервал.
...
Для отображения всех этих элементов достаточно создать файл с именем «**index.html**», указав в его теле только один тэг «**oda-game**», который и будет хостом этого компонента.
