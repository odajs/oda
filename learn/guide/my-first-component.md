...
Для создания эффекта взмахов крыльев к нем необходимо добавить анимационный тег **animate**, который будет поочередно скрывать и отображать их с заданным периодом в 0.3 секунды.
