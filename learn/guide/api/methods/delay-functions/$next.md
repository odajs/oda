...
Если второй параметр метода **undefined** явно не указан, то он будет иметь по умолчанию нулевой значение.
...
Данный пример будет работать абсолютно аналогично предыдущему примеру. Оба метода в нем будут выполняться практически сразу друг за другом со следующим тактом анимации.
