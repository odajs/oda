...
Этот параметр является массивам, длина которого определяет количество слоев нейросети, а значение каждого его элемента задает количество нейронов на каждом этом слое.
