...
Для использования в дальнейшем этот параметр нужно сохранить в специально предусмотренном для этого свойстве «**theTopology**» класса «**NeuralNetwork**».
...
Здесь для каждого слоя создается отдельный объект с типом «**NeuralSection**» с заданным количество нейронов на входе и на его выходе.
