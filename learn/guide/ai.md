...
Продемонстрируем эти свойства на примере игры «**Динозавр T-Rex**», научив компьютер автоматически принимать решение о необходимости преодоления динозавром препятствия в виде кактуса.

Для этого добавим к обычной игре js-модуль «**neural-net.js**», в котором объявим класс «**NeuralNetwork**» для представления нейронной сети.
