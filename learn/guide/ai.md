...
Если же сеть создается заново, то в конструкторе будет созданы ее слои в виде объектов специального класса «**NeuralSection**».
...
Описание класса «**NeuralSection**» будет дано чуть позже.
