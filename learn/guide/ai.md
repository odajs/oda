...
В этом классе архитектура нейросети задается с помощью параметра «**topology**», который передается конструктору следующим образом:
...
Для дальнейшего использования этого параметра его значение нужно предварительно сохранить в свойстве «**theTopology**» класса нейросети.
