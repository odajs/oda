...
Для использования это массива в других методах класса он сохраняется здесь в специально предусмотренном для этого свойстве «**theTopology**».
...
Сам процесс клонирования осуществляется вызовом метода «**clone1**», специально предусмотренного для этого в классе слоев нейросети «**NeuralSection**» .
