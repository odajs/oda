...
В этом примере используется модификатор «**javascript**», который говорит о том, что текст внутри блока написан на языке «**JavaScript**» и его необходимо подсветить следующим образом:
...
В системе документации синтаксис стандартного блок подсветки кода был расширен дополнительными модификаторами, которые позволяют увеличить его функциональные возможности. К таким модификаторам относятся:
