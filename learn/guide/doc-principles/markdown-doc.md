...
Для задания заголовков первого или второго уровня достаточно указать только один символ равно (=) или дефиса (-) на следующей строке. Последующие символы записываются только для красоты внутреннего оформления документа.
...
```text
Разные синтаксисы в одном документе не рекомендуется смешивать
```
