...
![Оглавление раздела](learn/_images/doc-principles_table-of-contents-01.png "Пример оглавления раздела")
...
![Структура папки](learn/_images/help_example3.jpg "Структура папки learn")
...
![Оглавление раздела](learn/_images/help_example.jpg "Пример оглавления раздела")
...
![Отображение раздела](learn/_images/help_example2.jpg "Отображение раздела")

Следует отметить, что в главном меню сайта отображаются только разделы первого и второго уровня.

![Главное меню](learn/_images/help_menu.jpg "Главное меню")
