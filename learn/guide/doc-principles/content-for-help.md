...
1. В папке «**guide**» создать подпапку с именем «**doc-principles**».

1. В файл ****_.dir**** папки «**guide**» добавить описание вновь созданной папки.
    ...
    [
        ...
        {
            "name": "doc-principles",
            "label": "Принципы документирования",
            "status": "check"
        }
    ]
    ```

    Порядок следования этого описания определяет его место в структуре оглавления.

1. В папке **doc-principles**
