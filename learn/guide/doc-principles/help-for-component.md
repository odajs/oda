...
1. Из папки «**tools**» в формировании оглавления на сайта сейчас будет использоваться только одна подпапка с именем «**calculator**».
1. В разделе «**tools**» оглавления на сайте подпункт «**calculator**» должен иметь имя «**Калькулятор**».
1. При нажатии на этот пункт должен отображаться пример работы компонента, находящийся в файле «**index.html**», который должен располагаться внутри указанной папки **calculator**».
