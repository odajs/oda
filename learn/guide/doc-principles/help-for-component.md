...
1. «**label**» — ключ, значение которого будет использоваться для вывода названия пункта меню для данного компонента на сайте.
...
1. Папка компонента. Например, «**calculator**».
...
В нем говорится, что в папке «**tools**» находится сейчас только одна подпапка с именем «**calculator**».
