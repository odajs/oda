...
Этот механизм первоначально необходимо настроить определенным образом.
...
Структура родительской папки с компонентами должна быть описана в ее служебном файла «**_.dir**» следующим образом:
...
Например, пусть компонент «**oda-calculator**» должен распологаться в папке «**tools**».
...
1. Пункт «**calculator**» в справочной системе на сайте должен называться «**Калькулятор**».
...
(https://odajs.org/learn/images/components/component5(2).png "Отображение краткого описания")
