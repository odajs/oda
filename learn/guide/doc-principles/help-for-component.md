...
![Папка с компонентами] (https://odajs.org/learn/images/components/component1.png "Папка с компонентами")
 ...
 Структуру этой папки нужно обязательно описать в файле с именем «**_.dir**» следующим образом:
...
Например, пусть компонент «**oda-calculator**» необходимо расположить внутри папки «**tools**».

![Папка tools] (https://odajs.org/learn/images/components/component0.png "Папка tools")

Тогда в эту папку нужно поместить покрайней мере два элемента:

1. Папку с файлами самого компонента. Например, «**calculator**».
1. Служебный файл «**_.dir**» с описанием структуры родительской папки «**tools**».
...
1. В папке «**tools**» находится только одна подпапка с компонентам «**calculator**».
1. При обращение к справочной системе пункт «**calculator**» на сайте должен отображаться как «**Калькулятор**».
...
1. В оглавлении у пункта «**Калькулятор**» должно отображаться краткое описание этого пункта, указанное в ключе **abstract**.
