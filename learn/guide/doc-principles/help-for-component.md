...
Имя этого файла принято задавать по имени компонента без приставки «**oda**», но с добавлением расширения «**.js**».

![JavaScript код компонента] (https://odajs.org/learn/images/components/component3.png "JavaScript код компонента")

Существует негласное соглашение, называть папку компонента то же по имени компонента без приставки «**oda**».

Например, файл с кодом компонента «**oda-calculator**» должен находится в папке с именем «**calculator**» и называться «**calculator.js**».

Кроме этого, имя файла принято называть по имени самого компонента, без приставки «**oda**».
