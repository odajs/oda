...
Этот файл должен быть записан в формате «**HTML**». Его имя может быть любым, но обще принято для него использовать имя «**index.html**». В любом случае это имя необходимо будет указать в файле «**_.dir**» в атрибуте «**link**». Именно этот файл и будет выводится в справочной системе.
