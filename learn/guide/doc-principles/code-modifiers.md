...
1. Модификатор «**copy**» позволяет отобразить дополнительную кнопку в верхнем правом углу редактора, с помощью которой можно скопировать весь написанный текст без дополнительного выделения его.
