...
1. Модификатор иконки «**имя-иконки**» позволяет вывести дополнительную иконку на левой границы области редактора кода.

    ```text
        ```javascript run_edit_[my-component.js]_console_warning
        ODA({
            is: 'my-component',
            template: `
                <div>Чтобы увидеть консоль, нажмите на кнопку в правом верхнем углу редактора.</div>
