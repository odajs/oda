...
1. Модификатор «**edit**» говорит о том, что текст в редакторе кода можно будет редактировать.
    ...
    Например, в следующим примере можно изменить любую строку кода.
...
1. Модификатор «**copy**» позволяет отобразить дополнительную кнопку в верхнем правом углу редактора, с помощью которой можно будет скопировать весь текст сообщения или кода в нем.
