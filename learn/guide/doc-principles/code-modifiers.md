...
1. Модификатор «**eh=значение**» позволяет задать фиксированную высоту области редактора кода.
    ...
    Данный модификатор следует использовать тогда, когда код примера будет по высоте очень большим.
...
1. Модификатор «**console**» позволяет задать дополнительную кнопку в верхнем правом углу области редактора кода, при нажатии на которую будет выводится содержимое консоли данного блока.
    ...
    Такое изменение в работе функции «**alert**» сделано специально для того, чтобы сообщения при загрузке страницы не выводились одновременно в отдельных модальных окнах ото всех примеров. После полной загрузки страницы все сообщения, отправленные функцией «**alert**», можно будут спокойно посмотреть в консоли каждого конкретного примера.

1. Модификатор иконки «**имя-модификатора**» позволяет вывести дополнительную иконку на левой границы области редактора кода.
    ...
    В этом случае левая граница рамки кода будет подсвечена красным цветом, и на ней будет отображаться соответствующая иконка.
    ...
    Кроме модификатора «**error**» можно использовать и другие модификаторы:
    ...
    1. «**warning**» — отображает желтая иконка с восклицательным знаком.
    1. «**help**» — отображаться иконка с синим вопросительным знаком.
    1. «**like**» — отображаться иконка с поднятым вверх большим пальцем.
    1. «**faq**» — отображаться иконка с изображением текстовой выноски.

1. Модификатор  «**hideicon**» позволяет спрятать изображении иконки на левой границы области редактора кода.
    ...
    В этом случае иконка с изображение красного крестика на левой границе редактора кода отображаться не будет, но сама граница будет подсвечена красным цветом.
...
1. Модификатор  «**hideGutter**» позволяет спрятать линейку с автоматической нумерацией строк кода.
    ...
    ```javascript run_edit_[my-component.js]_hideGutter
        ODA({
            is: 'my-component',
            template: `
                <div>Модификатор hideicon</div>
