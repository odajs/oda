...
1. Модификатор «**h=значение**» позволяет задать фиксированную высоту области вывода результата.
    ...
    Однако высоту окна вывода можно ограничить так, чтобы оно всегда имело фиксированный размер. Для этого достаточное указать требуемое значение в пикселях с помощью этого модификатора.
    ...
    В этом случае стандартная полоса прокрутки будет появляться тогда, когда действительная высота результата превысит указанное значение.
...
1. Модификатор «**eh=значение**» позволяет задать фиксированную высоту окна редактора кода.
  ...
  ```info md
    ...
    Если код в редакторе превысит указанную высоту, то с его правой стороны появится стандартная полоса прокрутки. С ее помощью можно будет просмотреть остальной, не умещающийся в окно код.
