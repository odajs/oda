...
1. Модификатор «**eh=значение**» позволяет задать фиксированную высоту окна редактора кода.
    ...
    Если код в редакторе превысит указанную высоту, то с его правой стороны появится стандартная полоса прокрутки, с помощью которой можно будет просмотреть остальной, не уместившийся в окно код.
