...
В этом примере элементы разметы «**Markdown**» двойные звезды «**\*\***» будут выводится как обычные символы, не приводя к изменению формата отображения текста, указанного в них.
