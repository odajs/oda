...
Например, при использовании типа оповещения «**warning**» рамка будет отображаться желтым цветом, а при изменении типа оповещения на значение «**error**» цвет левой границы рамки станет красным.
