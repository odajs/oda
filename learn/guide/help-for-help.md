...
* Ключ **name** позволяет задать имя файла, в котором будет храниться документ, или имя вложенной папки, в которой будут хранится документы вложенного подраздела в этот раздел.

* Ключ **label** задает надпись, которая будет выводится в оглавлении документации и содержать ссылку на сам документ.
