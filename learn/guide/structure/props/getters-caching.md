...
Примечание – Значения вычисляемых выражений, указанных в шаблоне компонента (в атрибуте **template**) кэшируются также как и значения методов компонента. Далее в этой статье для краткости изложения говорится только о кэшировании методов компонента.
