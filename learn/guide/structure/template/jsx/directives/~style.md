...
При использовании шаблонных литералов придется экранировать обратные одинарные кавычки (**`**) символом обратного слэша **\\**, так как такие кавычки уже используются при записи значения свойства **template**, а использовать вложенные одинаковые кавычки запрещено.
