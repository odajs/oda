...
В отличие от обычного задания inline CSS-стиля использование директивы **~style** позволяет включить механизм реактивности, так как любое изменение свойства компонента будет автоматически приводить к изменению стиля его отображения. Например:
...
Если объект задан в литеральной нотации, то включить механизм реактивности для его свойств можно только с помощью строковой интерполяции, обозначаемой знаком доллара и фигурными скобками.
