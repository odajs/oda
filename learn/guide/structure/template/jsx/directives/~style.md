...
При использовании шаблонных литералов придется экранировать каждый символ обратной одинарной кавычки (**`**), так как такие кавычки уже используются при записи значения свойства **template** компонента, а использование вложенных кавычек одного и того же типа без экранирования в языке JavaScript запрещено.
...
Автоматическое преобразование имен из верблюжьей нотацию в шашлычную (Kebab case) происходит и для любых свойств объектов, записанных внутри директивы **~style**.
