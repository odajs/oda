...
При использовании шаблонных литералов обратные одинарные кавычки (**`**), называемые грависами, придется экранировать символом обратного слэша **\\**, так как такие кавычки уже используются при записи свойства **template** самого компонента, в котором такие кавычки предполагается указать повторно.
