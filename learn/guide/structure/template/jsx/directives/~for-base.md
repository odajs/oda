...
В примере из массива **array** последовательно извлекаются все элементы, и для каждого из них создается свой собственный HTML-элемент **div**. В этот элемент выводится значение текущего элемента массива, которое берется из переменной **item**.
