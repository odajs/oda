...
Этот пример аналогичен предыдущему с учетом того, что помимо значения элемента массива также выводится его индекс в массиве, находящийся в переменной цикла **index**.
