...
1. Обработка неопределенных элементов массивов.
    ...
    В этом примере при объявлении массива **array** пропущен элемент с индексом **1**. Однако директива **~for** все равно создает для него очередной HTML-элемент **div** и будет использовать вместо имени пропущенного элемента значение **undefined**.
