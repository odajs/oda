...
В обоих модулях есть строки, которые добавляют на веб-страницу элемент **div** с соответствующим сообщением, чтобы продемонстрировать момент загрузки каждого модуля.
