...
В примере геттер **getterTime** в своем коде не содержит обращение к свойству **change**, но он вызывает метод **hiddenChange**, в котором такое обращение присутствует, поэтому при любом изменении текста в строке ввода обновляется текущее время на странице.
